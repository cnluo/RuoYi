 ...
 */
@Service
public class SystemUserLoginRememberMeService extends CookieRememberMeManager {
    /**
    ...
    public PrincipalCollection getRememberedPrincipals(SubjectContext subjectContext) {
        ...
        for (Object principal : principals) {
            if (principal instanceof SysUser) {
                SpringUtils.getBean(SystemLoginService.class).setRolePermission((SysUser) principal);
            }
        }
        return principals;
    }
