 ...
 */
@Service
public class OnlineSessionService extends EnterpriseCacheSessionDAO {
    /**
     ...
     * 上次同步数据库的时间戳
     */
    private static final String LAST_SYNC_DB_TIMESTAMP = OnlineSessionService.class.getName() + "LAST_SYNC_DB_TIMESTAMP";
    ...
    public OnlineSessionService(long expireTime) {
        super();
    }
