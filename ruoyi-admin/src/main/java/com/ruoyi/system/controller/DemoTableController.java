...
import com.ruoyi.system.domain.demo.DocumentModel;
import com.ruoyi.system.domain.demo.UserTableColumn;
import com.ruoyi.system.domain.demo.UserTableModel;
...
public class DemoTableController extends BaseController {
    ...
    @ResponseBody
    public R exportSelected(UserTableModel userModel, String userIds) {
    ...
    @ResponseBody
    public R ajaxColumns(UserTableColumn userColumn) {
