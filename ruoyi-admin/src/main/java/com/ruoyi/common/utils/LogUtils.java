...
public class LogUtils {
    ...
    public static void logAccess(HttpServletRequest request) {
        ...
        String s = getBlock(username) + getBlock(jsessionId) + getBlock(ip) + getBlock(accept) + getBlock(userAgent) + getBlock(url) + getBlock(params) + getBlock(request.getHeader("Referer"));
        getAccessLog().info(s);
    }
    ...
    public static void logError(String message, Throwable e) {
        String username = getUsername();
        String s = getBlock("exception") + getBlock(username) + getBlock(message);
        ERROR_LOG.error(s, e);
    }
